/**
 * =====================================================
 * RETROUVONSLES - Operator Create Person Page
 * Création d'une fiche personne détaillée
...
export const CreatePersonPage: React.FC = () => {
  ...
  return (
    <OperatorLayout title={t('operator.createPerson') || 'Créer une fiche personne'}>
      <div className={styles.createPerson}>
        ...
        <div className={styles.createPerson__content}>
          ...
          <div className={styles.createPerson__actions}>
            <button type="button" className={styles.createPerson__cancelBtn} onClick={() => navigate('/operator/dashboard')} disabled={isSubmitting}>
              Annuler
            </button>
